                            ...
                            <aside id="sidebar">
                                <section style="text-align:right;">
									...
									$rbSql = '
											...
											LIMIT 16 
										';
									//end of code by Hamlet
									?>
									<?php $rbRes = mysql_query($rbSql);?>
									<?php if(mysql_num_rows($rbRes) > 0):?>
										<?php while($rbRow = mysql_fetch_object($rbRes)):?>
											<?php 												$imgAlt  	= stripslashes($rbRow->uaTitle);
                                            ...
                                            <a href="<?=$link?>" <?php if($linkTarget != ''){echo 'target="'.$linkTarget.'"';} ?> class="" style="padding:0px;">
									...
									?>
                                    <?php foreach($esbArr_s as $key => $arr): ?>
                    	...
                    	<div class="col-md-12 col-sm-12">
                            <div class="row">
								...
								//Code edited by Hamlet
									...
									//end of code by Hamlet
								?>
								<?php $fbRes = mysql_query($fbSql);?>
                                <?php if(mysql_num_rows($fbRes) > 0):?>
									<?php  while($fbRow = mysql_fetch_object($fbRes)):?>
										<?php 											$imgAlt  	= stripslashes($fbRow->uaTitle);
                                        ...
                                        <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 aligh-center">
                                            <a href="<?=$link?>" <?php if($linkTarget != ''){echo 'target="'.$linkTarget.'"';} ?> class="item-horizontal small" style="padding:0px; margin-bottom:20px;">
                                ...
                                <?php foreach($esbArr_b as $key => $arr): ?>
                                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 aligh-center">
...
<script>
	<?php if(isset($itemMapData) || isset($itemGallery) && $itemGallery): ?>
...
<?php if($currentPage == 'register.php' || $currentPage == 'view-listing.php' || $currentPage == 'contact-us.php'): ?>
