...
$user 	= "qatar001_adm";	//Enter MySql DB Username
$pass 	= ")cTQ9DuS_DPR";		//Enter MySql DB User Password
$db 	= "qatar001_db";		//Enter Mysql DB Name

$domain = $domainOnly;
$siteBaseUrl = '/';
//$adminBaseUrl = '/admin/';
$adminBaseUrl = '/hala/admin/';
$systemEmailAddress = "noreply@qatarimall.com";
...
$advertStatusArr = array(
	'PE'=> '<span class="text-yellow">Pending1/span>',
	'A' => '<span class="text-green">Active1</span>',
	'I' => '<span class="text-red">Inactive1</span>'
);



$advertType = array(
    'SB'=> '<span class="text-yellow">Side Banner</span>',
    'B' => '<span class="text-green">Bottom</span>',
    'IB1' => '<span class="text-red">Inner Banner 1000 px</span>',
    'IB5' => '<span class="text-red">inner banner 500x500</span>',
    'FBL' => '<span class="text-red">Feature Business Listing</span>'
);
