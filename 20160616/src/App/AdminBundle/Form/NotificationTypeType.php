...
class NotificationTypeType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('icon', 'text', array('attr' => array('class' => 'm-wrap large')))
            ->add('color', 'text', array('attr' => array('class' => 'm-wrap large')))
            ->add('onBody', 'checkbox', array('attr' => array('class' => 'm-wrap large')))
        ;
    }
