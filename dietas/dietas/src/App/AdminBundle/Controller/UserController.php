...
class UserController extends Controller
{
    ...
    public function buyModule($id){
        ...
        if ($earnings >= $module->getCost()) {
            $userModule = new UserModule();
            $userModule->setUser($user);
            $userModule->setModule($module);
            $userModule->setActivationDate(date_create_from_format('Y-m-d', date('Y-m-d')));
            $em->persist($userModule);
            $earnings = $earnings - $module->getCost();
            ...
            $transaction->setMoney($module->getCost() * -1); //un descuento
            ...
            $notification->setDate(date_create_from_format('Y-n-j', date('Y-m-d')));
            //----------------------
