...
abstract class AbstractDoctrineExtension extends Extension
{
    ...
    /**
     * Join the alias for this mapping driver.
     *
    ...
    /**
     * Join the mapping driver configuration for later use with the object managers metadata driver chain.
     *
     * @param array  $mappingConfig
     * @param string $mappingName
     *
    ...
    /**
     * Join all the collected mapping information with the object manager by registering the appropriate mapping drivers.
     *
