 ...
 */
class BankAccount extends \App\AdminBundle\Entity\BankAccount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\BankAccount' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\BankAccount' . "\0" . 'code', '' . "\0" . 'App\\AdminBundle\\Entity\\BankAccount' . "\0" . 'money', '' . "\0" . 'App\\AdminBundle\\Entity\\BankAccount' . "\0" . 'lastUpdate', 'user');
        }
