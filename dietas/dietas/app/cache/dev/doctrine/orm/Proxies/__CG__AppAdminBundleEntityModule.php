...
class Module extends \App\AdminBundle\Entity\Module implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\Module' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\Module' . "\0" . 'name', '' . "\0" . 'App\\AdminBundle\\Entity\\Module' . "\0" . 'description', '' . "\0" . 'App\\AdminBundle\\Entity\\Module' . "\0" . 'cost', '' . "\0" . 'App\\AdminBundle\\Entity\\Module' . "\0" . 'activeDays', '' . "\0" . 'App\\AdminBundle\\Entity\\Module' . "\0" . 'onBody', 'userModule', '' . "\0" . 'App\\AdminBundle\\Entity\\Module' . "\0" . 'products');
        }
