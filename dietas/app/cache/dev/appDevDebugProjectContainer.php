...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_505c2e365872280b5a35609e0312c8c9ed3d57a898de8d8e214476e479f0e69d');
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/homepage');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/login');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/join');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/contact');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/about');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/product');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/products/type');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/backoffice/^');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/backoffice/config/^');

        $p = new \Symfony\Component\ExpressionLanguage\SerializedParsedExpression('has_role("ROLE_ADMIN")', 'O:54:"Symfony\\Component\\ExpressionLanguage\\Node\\FunctionNode":2:{s:5:"nodes";a:1:{s:9:"arguments";O:46:"Symfony\\Component\\ExpressionLanguage\\Node\\Node":2:{s:5:"nodes";a:1:{i:0;O:54:"Symfony\\Component\\ExpressionLanguage\\Node\\ConstantNode":2:{s:5:"nodes";a:0:{}s:10:"attributes";a:1:{s:5:"value";s:10:"ROLE_ADMIN";}}}s:10:"attributes";a:0:{}}}s:10:"attributes";a:1:{s:4:"name";s:8:"has_role";}}');
        ...
        $q->add($n, array(0 => 'ROLE_FREE', 1 => 'ROLE_PAYMENT', 2 => 'ROLE_ADMIN'), NULL);
        $q->add($o, array(0 => $p), NULL);
        ...
        $t->setOptions(array('login_path' => '/login', 'always_use_default_target_path' => true, 'default_target_path' => '/backoffice', 'target_path_parameter' => '_target_path', 'use_referer' => false));
