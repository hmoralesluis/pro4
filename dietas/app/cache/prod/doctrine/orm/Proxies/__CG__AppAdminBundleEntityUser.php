...
class User extends \App\AdminBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'contactPhone', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'city', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'skype', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'whatsapp', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'facebook', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'twitter', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'google', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'signUpDate', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'generation', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'positionInGeneration', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'photo', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'temp', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'photoExtension', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'active', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'country', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'networkUsers', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'asociatedUser', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'notifications', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'products', '' . "\0" . 'App\\AdminBundle\\Entity\\User' . "\0" . 'transactions', 'userModule');
        }
    ...
    public function setAsociatedUser(\App\AdminBundle\Entity\User $asociatedUser = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAsociatedUser', array($asociatedUser));

        return parent::setAsociatedUser($asociatedUser);
    }
    ...
    public function getAsociatedUser()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAsociatedUser', array());

        return parent::getAsociatedUser();
    }
    ...
    public function getPhotoName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPhotoName', array());
