...
class Option
{
    ...
    public function propertiesToShow()
    {
        return array(
            ...
            array(
                'fieldName' => 'Path', 'fieldValue' => $this->path, 'fieldClasification' => 'optional', 'fieldOrder' => 2),
            array(
                'fieldName' => 'Icon', 'fieldValue' => $this->icon, 'fieldClasification' => 'optional', 'fieldOrder' => 3),
            array(
                'fieldName' => 'AsociatedOption', 'fieldValue' => ($this->asociatedOption !== null) ? $this->asociatedOption->getName() : '' , 'fieldClasification' => 'optional', 'fieldOrder' => 4)
        );
    }
