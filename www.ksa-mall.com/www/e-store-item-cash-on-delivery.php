<?
	...
	$pRes = mysql_query('
		...
		FROM products AS p 
		WHERE p.seoUrl = "'.mysql_real_escape_string($seoUrl).'" AND p.cod = "Y" 
	');
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if(array_key_exists('frmsubmit', $_POST) && $_POST['frmsubmit'] == "signin"){        
			$Sql = '
				SELECT userID, password, fullname, email, profileImg FROM users WHERE 
                            ...
                            <div class="row">
												...
												if(isset($_POST['bName'])){
													...
													if($bName == '' || $bEmail == '' || $bTelephone == '' || $bAddress == ''){
														...
														if(mysql_query($insertSql)){
															...
															$infoEMsg .= '<td>Cash on Delivery</td>';
															$infoEMsg .= '</tr>';
															$infoEMsg .= '<tr>';
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12">
                                    <div class="list-group">
                                        ...
                                        <a href="javascript:void(0)" class="list-group-item list-group-item-info aligh-center">Cash on Delivery</a>
                                    </div>
                                </div>
                            </div>
                        </article>
