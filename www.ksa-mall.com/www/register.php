	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		if(array_key_exists('frmsubmit', $_POST)){
			...
			if($responseData->success){
				...
				$frmResponse	= '<div class="alert-box error"><span>error: </span>Robot verification failed, please try again.</div>';
			}
		}
	}
...
<div class="center">
    ...
    <form role="form" id="form-register" method="post" action="register.php">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="form-register-password" name="form-register-password"  value="<?php echo $password; ?>" required placeholder="A-Z, 0-9 & Special Char, min 6 Charectors">
        </div><!-- /.form-group -->
        <div class="form-group">
