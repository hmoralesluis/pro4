...
// Set width for inputs in horizontal search bar -----------------------------------------------------------------------
    ...
    /*$( "#redefine-search-form" ).load( "/new/assets/external/_search-bar.php", function() {
        setInputsWidth();
        //autoComplete();
    });*/
...
//  iCheck -------------------------------------------------------------------------------------------------------------
    ...
    $('a:not([target]:has([href])').on('click', function (e) {
...
function autoComplete(){
    if( !$("script[src='/new/assets/js/leaflet.js']").length ){
...
function drawOwlCarousel(_rtl){
    $.getScript( "/new/assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
        ...
        if( category == 'real_estate' ){
            if( json.data[a].item_specific ){
                if( json.data[a].item_specific.bedrooms ){
                    itemSpecific += '<span title="Bedrooms"><img src="/new/assets/img/bedrooms.png">' + json.data[a].item_specific.bedrooms + '</span>';
                }
                if( json.data[a].item_specific.bathrooms ){
                    itemSpecific += '<span title="Bathrooms"><img src="/new/assets/img/bathrooms.png">' + json.data[a].item_specific.bathrooms + '</span>';
                }
                if( json.data[a].item_specific.area ){
                    itemSpecific += '<span title="Area"><img src="/new/assets/img/area.png">' + json.data[a].item_specific.area + '<sup>2</sup></span>';
                }
                if( json.data[a].item_specific.garages ){
                    itemSpecific += '<span title="Garages"><img src="/new/assets/img/garages.png">' + json.data[a].item_specific.garages + '</span>';
                }
                return itemSpecific;
            }
        }
...
function quickView(id){
    $.ajax({
        type: 'POST',
        url: '/new/assets/external/_modal.php',
        data: id,
