    ...
    <div class="row">
        ...
        <div class="col-md-8 col-sm-8">
            <section style="margin-bottom:0px;">
                ...
                <? if($videoRes && mysql_num_rows($videoRes) > 0): ?>
            ...
            <?
				...
				');
			?>
            <? if($featuredRes && mysql_num_rows($featuredRes) > 0): ?>
            	<style type="text/css">
            	...
            	<section id="featuredListings" class="block background-color-grey-dark" style="padding:40px 20px;">
                    ...
                    <div class="row">
                        <? while($featuredRow = mysql_fetch_object($featuredRes)): ?>
                            <?
                                $imgPath = stripslashes($featuredRow->imgPath);
			...
			?>
            <? if($ymalRes && mysql_num_rows($ymalRes) > 0): ?>
                <section id="categories" class="block background-color-white" style="padding:40px 20px; background-color:#bdbdbb;">
                    ...
                    <div class="row">
                        <? while($ymalRow = mysql_fetch_object($ymalRes)): ?>
                            <? 
            ...
            <?
				...
				');
			?>
            <? if($bsize4Res && mysql_num_rows($bsize4Res) > 0): ?>
            	<section class="block equal-height" style="padding:40px 0px;">
                    <div class="row">
                        <? while($bsize4Row = mysql_fetch_object($bsize4Res)): ?>
                            <div class="col-sm-6">
