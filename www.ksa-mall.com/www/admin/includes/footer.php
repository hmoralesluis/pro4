        ...
        <script src="<?=$adminBaseUrl?>js/plugins/morris/morris.min.js" type="text/javascript"></script>
        <!-- Sparkline -->
        <script src="<?=$adminBaseUrl?>js/plugins/sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
        <? if(isset($isMapPage)): ?>
        <!-- jvectormap -->
        <script src="<?=$adminBaseUrl?>js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js" type="text/javascript"></script>
        <script src="<?=$adminBaseUrl?>js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
        <? endif; ?>
        <!-- jQuery Knob Chart -->
        <script src="<?=$adminBaseUrl?>js/plugins/jqueryKnob/jquery.knob.js" type="text/javascript"></script>
        <!-- InputMask -->
        <script src="<?=$adminBaseUrl?>js/plugins/input-mask/jquery.inputmask.js" type="text/javascript"></script>
        <script src="<?=$adminBaseUrl?>js/plugins/input-mask/jquery.inputmask.date.extensions.js" type="text/javascript"></script>
        <script src="<?=$adminBaseUrl?>js/plugins/input-mask/jquery.inputmask.extensions.js" type="text/javascript"></script>
        <!-- daterangepicker -->
        <script src="<?=$adminBaseUrl?>js/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>
        <!-- datepicker -->
        <script src="<?=$adminBaseUrl?>js/plugins/datepicker/bootstrap-datepicker.js?v=1.0.1" type="text/javascript"></script>
        <!-- bootstrap color picker -->
        <script src="<?=$adminBaseUrl?>js/plugins/colorpicker/bootstrap-colorpicker.min.js" type="text/javascript"></script>
        <!-- bootstrap time picker -->
        <script src="<?=$adminBaseUrl?>js/plugins/timepicker/bootstrap-timepicker.min.js" type="text/javascript"></script>
        <!-- Bootstrap WYSIHTML5 -->
        <script src="<?=$adminBaseUrl?>js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
        <!-- iCheck -->
        <script src="<?=$adminBaseUrl?>js/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
        
        <script src="<?=$adminBaseUrl?>js/jquery.popupWindow.js?v=1.0.2" type="text/javascript"></script>
        
        <script src="http://maps.googleapis.com/maps/api/js?libraries=places&sensor=false"></script>
		<script src="<?=$adminBaseUrl?>js/jquery.geocomplete.min.js?v=1.1.2"></script>
        
        <!-- BootBox Custom Alert -->
        <script src="<?=$adminBaseUrl?>js/bootbox.min.js" type="text/javascript"></script>
        ...
        <!-- DATA TABES SCRIPT -->
        <script src="<?=$adminBaseUrl?>js/plugins/datatables/jquery.dataTables.js" type="text/javascript"></script>
        <script src="<?=$adminBaseUrl?>js/plugins/datatables/dataTables.bootstrap.js" type="text/javascript"></script>
        
        <!-- SELECT -->
        <script src="//cdnjs.cloudflare.com/ajax/libs/select2/4.0.0-rc.2/js/select2.min.js"></script>
        
        <!-- AdminLTE App -->
        <script src="<?=$adminBaseUrl?>js/AdminLTE/app.js?v=1.2.10" type="text/javascript"></script> 
        <script type="text/javascript">
			$('.select2').select2();
		</script>
        ...
        <script type="text/javascript">
            $(function() {
				$('.datePicker').datepicker({'autoclose':true, allowDeselection: false});
                //Datemask dd/mm/yyyy
				...
				//How to use Data Table https://legacy.datatables.net/examples/data_sources/server_side.html
            });
        </script>
        
        <script type="text/javascript" src="<?=$adminBaseUrl?>tinymce/tinymce.min.js?v=4.1.8"></script>
        <script src="<?=$adminBaseUrl?>js/lightbox.min.js?v=2.7.1.1"></script>
		...
		<script type="text/javascript">
            ...
            tinymce.init({
			   ...
			   toolbar1: "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image insertimage insertfile",
			   toolbar2: "print preview media | fontselect fontsizeselect forecolor backcolor emoticons | print preview media fullpage",
               convert_urls:false, 
               relative_urls : false, 
        ...
        <script type="text/javascript">
			...
			$(document).on('blur', '.onblurUpdate', function(event){
				...
				setTimeout(function() {
					var a		= thisE.data('a');
					var ids		= thisE.data('ids');
					var url		= thisE.data('url');
					var val		= thisE.val();
        ...
        <script type="text/javascript">
			$(function() {
				...
				<?
					$cWiseCustomersRes = mysql_query('
						SELECT COUNT(*) AS totCus, c.countryCode, c.countryName 
						FROM `users` AS u
						LEFT JOIN countries AS c ON c.countryName = u.countryName 
						GROUP BY u.countryName
					');
					
					$customersData = '';
					
					if(mysql_num_rows($cWiseCustomersRes) > 0){
						while($cwcRow = mysql_fetch_object($cWiseCustomersRes)){
							$customersData .= '"'.$cwcRow->countryCode.'": '.$cwcRow->totCus.',';
						}
						$customersData = rtrim($customersData, ",");
					}
				?>
        ...
        <? if($currentPage = 'manage-our-schedules.php'): ?>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $('#calendar').fullCalendar({
                    ...
                    events: {
						url: 'manage-our-schedules-post.php',
						type: "POST",
						data: {'a': 'getAllEvents'}, 
						success:function(jSonData, textStatus, jqXHR){
							//console.log(jSonData);
					...
					eventResize: function(Event) {
						var start = Event.start, end = Event.end;
						console.log('Before Format: '+start+' | '+end);
						...
						if(start !== null){
							...
							console.log('After Format: '+start+' | '+end);
                    ...
                    drop: function(date, allDay) { // this function is called when something is dropped
						...
						/*console.log('title: '+copiedEventObject.title);
						console.log('start: '+date.format("YYYY-MM-DD HH:mm:ss"));
						console.log('end: '+date.format("YYYY-MM-DD HH:mm:ss"));
						console.log('allDay: true');
						console.log('url: ');
						console.log('backgroundColor: '+rgb2hex($(this).css("background-color")));
						console.log('borderColor: '+rgb2hex($(this).css("border-color")));*/
						...
						$.ajax({
							...
							data : {
								...
								'allDay'		 : 'true',
								'url'			 : '',
								'backgroundColor': rgb2hex($(this).css("background-color")),
								'borderColor'	 : rgb2hex($(this).css("border-color"))
							},
							success:function(jSonData, textStatus, jqXHR){
								console.log(jSonData);
								var data = jSonData;
        ...
        <script type="text/javascript">
			$(document).on('click', '.gotoPage', function(event){
				...
				if($('#'+no).val() > 0){
					window.location.href = '?pageNo='+$('#'+no).val();
				}else {
					showAlert('Please Enter Page No.');
					$('#'+no).focus();
				}
			});
		</script>
		...
		<script type="text/javascript">
			$(document).on('click', '.make-featured', function(event){

				var featured_val = $(this).is(':checked') ? 1 : 0;

				var data = {
					'a': $(this).data('a'),
					'url': $(this).data('url'),
					'id': $(this).data('id'),
					'check_status': featured_val
				}
