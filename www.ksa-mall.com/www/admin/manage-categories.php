...
<? require_once('includes/header.php'); ?>
    ...
    <div class="popupWrapper" id="addCategoryWindow">
        <div class="popupWindow" style="min-width:70%">
            <div class="titleBar"><span>Add Category</span></div>
            ...
            <div class="inner">
                ...
                <form action="<?=$formPostUrl?>" method="post" data-numbering="categoryRow" data-column="1" class="form-horizontal afs">
                    ...
                    <label for="acatName">Category Name *</label>
                    ...
                    <input type="submit" name="submitBtn" class="btn btn-info" value="Add Category" />
                </form>
                </div>
            </div>
        </div>
                ...
                <div class="box-header">
                    <div class="box-title clearfix" style="float:none; display:block;">
                        ...
                        <div class="pull-right">
                            <button class="btn btn-info addPopup" data-w="addCategoryWindow">Add New Category</button>
                        </div>
                    </div>
                </div><!-- /.box-header -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="categoryTable">
                            ...
                            <tr>
                                ...
                                <th>Category Name</th>
                                <th>SEO Url</th>
                                <th class="hidden-sm hidden-md">Manage Sub Category</th>
                            ...
                            <? $categoryUrl = 'http://'.$row->catSeoUrl.'.'.$domain; ?>
                            <tr class="categoryRow" id="categoryRow_<?=$row->catID?>">
                                <td><?=$sNo?></td>
                                <td id="td_cN_<?=$row->catID?>"><?=$row->catName?></td>
                                <td id="td_sU_<?=$row->catID?>">
								<a href="<?=$categoryUrl?>" title="View Category in Website" target="_blank"><?=$categoryUrl?></a>
                                </td>
                                <td>
                                <a href="manage-sub-categories.php?parentID=<?=$row->catID?>" title="Manage Sub Categories">
                                Sub Category (<?=$row->totalSCs?>)
                                </a>
                                </td>
                                <td width="120">
