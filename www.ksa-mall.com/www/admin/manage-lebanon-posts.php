<?
	...
	$_SESSION['imgManagerFileSelectPath'] = '/new/images/userfiles/';
	$_SESSION['imgManageruploadMaxSize'] = '30M';
	
	$header = array(
		'siteTitle' => 'Manage Lebanon Posts', 
		'loginName' => $_SESSION['admin']['name'], 
		'cMenuCat'	=> 'manage-contents',
		'cMenu'		=> 'manage-lebanon-posts', 
		'breadcrumb'=> array(
			array('url' => '', 'text' => 'Manage Lebanon Posts')
		)
	);
...
<? require_once('includes/header.php'); ?>
    ...
    <div class="popupWrapper" id="addLbpWindow">
        <div class="popupWindow" style="min-width:70%">
            <div class="titleBar"><span>Add Lebanon Post</span></div>
            ...
            <div class="inner">
                ...
                <form action="<?=$formPostUrl?>" method="post" data-numbering="lbpRow" data-column="1" class="afs">
                    ...
                    <label for="albpTitle">Lebanon Title </label>
                    <input type="text" class="form-control" name="albpTitle" id="albpTitle" value="" />
                    
                    <label for="albpImg" style="display:block;">Lebanon Image *</label>
                    ...
                    <input type="submit" name="submitBtn" class="btn btn-info" value="Add Lebanon Post" />
                </form>
                </div>
            </div>
        </div>
    ...
    <div class="popupWrapper" id="editBpWindow">
        <div class="popupWindow" style="min-width:70%">
            <div class="titleBar"><span>Edit Lebanon Post</span></div>
            <a href="javascript:void(0)" class="closeButton" title="Close Window"><i class="fa fa-close"></i></a>
            <div class="inner">
                <div style="padding:15px;">
                <form action="<?=$formPostUrl?>" method="post" class="afs">
                    ...
                    <label for="eBpTitle">Lebanon Title </label>
                    <input type="text" class="form-control" name="eBpTitle" id="eBpTitle" value="" />
                    
                    <label for="elbpImg" style="display:block;">Lebanon Image *</label>
                    ...
                    <input type="submit" name="submitBtn" class="btn btn-info" value="Save Lebanon Post" />
                </form>
                </div>
            </div>
        </div>
                ...
                <div class="box-header">
                    <div class="box-title clearfix" style="float:none; display:block;">
                        ...
                        <div class="pull-right">
                            <button class="btn btn-info addPopup" data-w="addLbpWindow">Add New Lebanon Post</button>
                        </div>
                    </div>
                </div><!-- /.box-header -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="lbpTable">
                            ...
                            <tr class="lbpRow" id="lbpRow_<?=$row->lbpID?>">
                                ...
                                <button type="button" class="btn btn-sm btn-danger deleteIcon" data-placement="top" data-original-title="Delete" data-id="<?=$row->lbpID?>" data-a="delLbp" data-u="<?=$formPostUrl?>" data-at="Lebanon Post" data-numbering="lbpRow" data-column="1" >
