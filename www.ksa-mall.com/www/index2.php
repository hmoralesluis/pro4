...
<section class="block equal-height" style="padding-top:0px !important;">
            ...
            <div class="fullwidthbanner">
                <ul>
                    ...
                    <li <?=$animAttr?> data-thumb="">
                        <img src="<?=stripslashes($slideRow->imgPath)?>" alt="<?=stripslashes($slideRow->imgAlt)?>" title="<?=stripslashes($slideRow->imgAlt)?>" />
                    </li>
                    <? endwhile; ?>
                </ul>
	...
	<?
		$flRes = mysql_query('
			...
			WHERE bl1.featured = "1" 
			AND bl1.expiryOn >= "'.date('Y-m-d').'" AND bl1.status = "A" 
