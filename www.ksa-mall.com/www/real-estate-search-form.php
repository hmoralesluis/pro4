...
?>
<form class="main-search" role="form" method="get" action="http://real-estate.<?=$domain?>/search/" id="mainSearchForm">
	<div class="input-row">
    ...
    <div class="input-row">
        ...
        <div class="col-xs-12 col-sm-3 col-md-2 k-table">
            ...
            <div class="inline-block">
        	<input type="text" class="form-control" name="sfref" id="sfref" value="<?=$value?>" placeholder="Ex: RL-1029" />
            </div>
        </div>
