...
class Role extends \App\AdminBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'App\\AdminBundle\\Entity\\Role' . "\0" . 'role', '' . "\0" . 'App\\AdminBundle\\Entity\\Role' . "\0" . 'users', '' . "\0" . 'App\\AdminBundle\\Entity\\Role' . "\0" . 'options', '' . "\0" . 'App\\AdminBundle\\Entity\\Role' . "\0" . 'products');
        }
