...
class User implements UserInterface, AdvancedUserInterface, \Serializable
{
    ...
    /**
     * this is not a persistent field
     */
    private $temp;
     ...
     *
     * @ORM\OneToMany(targetEntity="User", mappedBy="asociatedUser", cascade={"all"}, fetch="EAGER")
     */
    private $networkUsers;

    /**
     * @var User $asociatedUser
     *
     * @ORM\ManyToOne(targetEntity="User", inversedBy="networkUsers", fetch="EAGER")
     * @ORM\JoinColumns({
     * @ORM\JoinColumn(name="asociatedUser_id", referencedColumnName="id")
     * })
     */
    private $asociatedUser;
     ...
     * @return User
     */
    public function setAsociatedUser(\App\AdminBundle\Entity\User $asociatedUser = null)
    {
        $this->asociatedUser = $asociatedUser;
     ...
     */
    public function getAsociatedUser()
    {
        return $this->asociatedUser;
    }
    ...
    {
        return $this->photo ? md5($this->username) . '.' . $this->photoExtension : 'avatar.png';
    }

    public function getAbsolutePath()
    {
        return null === $this->photoExtension
            ? null
            : $this->getUploadRootDir() . '/' . md5($this->username) . '.' . $this->photoExtension;
    }
    ...
    public function getWebPath()
    {
        return null === $this->photoExtension
            ? null
            : $this->getUploadDir() . '/' . md5($this->username) . '.' . $this->photoExtension;
    }
    ...
    public function preUpload()
    {
        if (null !== $this->getPhoto()) {
            $this->photoExtension = $this->getPhoto()->guessExtension();
        }
    }
    ...
    public function upload()
    {
        ...
        $this->getPhoto()->move(
            ...
            md5($this->username) . '.' . $this->getPhoto()->guessExtension()
        );
