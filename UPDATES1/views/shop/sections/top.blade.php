    ...
    <div class="container no-padding">
        ...
        <nav class="top-bar animate-dropdown navbar">
            <div class="container">
                ...
                <div class="col-xs-12 no-margin col-sm-1  col-sm-push-5 ">
                    <ul>
                        <li>
                            <a href="{{ url('lang', ['es']) }}" style="  padding-bottom: 5px; padding-top: 5px;">
                                <img alt="es" src="{{url('shop/assets/images/flags/es.png')}}" width="24" height="18">
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('lang', ['en']) }}"style="  padding-bottom: 5px; padding-top: 5px;">
                                <img alt="en" src="{{url('shop/assets/images/flags/en.png')}}"width="24" height="18">
                            </a>
                        </li>
                    </ul>
                ...
                @if(session('lang') == 'es')
                     <div class="col-xs-12 no-margin col-sm-6  col-sm-push-6">
                @elseif(session('lang') == 'en')
                     <div class="col-xs-12 no-margin col-sm-5  col-sm-push-7">
                @endif
