                        ...
                        <div class="container-fluid">
                            <div class="caption vertical-center text-right right" style="padding-right:0;">
                                <div class="big-text fadeInDown-1">
                                    <span class="big">Proveedor de </span> <span class="medium"><span class="sign"></span> repuestos para automatización </br>industrial  en todo el mundo</span>
                                </div>
                            </div><!-- /.caption -->
                        </div><!-- /.container-fluid -->
                    </div><!-- /.item -->
...
<section id="banner-holder" class="wow fadeInUp">
    <div class="container">
        <div class="row marketing">
            <h5 class=" h3 text-center text-about-green">Nuestra empresa proporciona </br> partes,
                repuestos, partes y piezas para los sistemas de control (PLC) instalados.</br>
