...
@section('content')
    ...
    @if(Session::has('flash_message'))
        ...
        <div class="alert alert-success">
            <strong>Bien!!!!</strong> Producto adicionado<br><br>
            <ul>
                    <li>
    ...
    <form method="post" class="form-horizontal" action="{{url('admin/product/store')}}" enctype="multipart/form-data"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <input  required="true" type="text" name="mark" id="form-field-2" placeholder="Marca" />

                </br>
                </br>

                <input  required="true" type="text" name="part_number" id="form-field-3" placeholder="Numero de parte" />
