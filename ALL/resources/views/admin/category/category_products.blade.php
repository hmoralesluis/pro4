...
@section('page_title')
    <h3 class="header smaller lighter blue">Productos fabricante: {{$category->name}}</h3>
...
@section('content')
    ...
    @if(Session::has('flash_message'))
        ...
        <div class="alert alert-success">
            <strong>Bien!!!!</strong> Producto eliminado<br><br>
            <ul>
                <li>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="table-header">
                Productos fabricante: {{$category->name}}
                <a class="btn btn-success" href="{{url('admin/product/create')}}"> Nuevo   </a>
            </div>


            <div class="search_product pull-right">
                <form action="{{url('admin/products/category/'.$category->id .'/search')}}" method="get" class="form-search">
