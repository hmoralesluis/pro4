...
<section id="banner-holder" class="wow fadeInUp">
    <div class="container">
        ...
        <div class="mark_div col-xs-12 col-sm-6 sol-md-3 col-lg-3 no-margin  ">
             <div class="row">
                 <div class="col-xs-12"> <p>  <img class="marketing-image" alt=""  src="shop/assets/images/banners/round1.png" /></p></div>

                 <div class="col-xs-12"><p class="text-center-home">  {{trans('index.body.mision1')}}  </p></div>
             </div>
        </div>
        ...
        <div class="mark_div col-xs-12 col-sm-6 sol-md-3 col-lg-3 no-margin  ">
            <div class="row">
                ...
                <div class="col-xs-12"><p><img class="marketing-image " alt=""   src="shop/assets/images/banners/round2.png" /> </p></div>
        ...
        <div class="mark_div col-xs-12 col-sm-6 sol-md-3 col-lg-3 no-margin ">
            <div class="row">
            <div class="col-xs-12"> <p> <img class="marketing-image" alt=""   src="shop/assets/images/banners/round3.png" />  </p></div>
        ...
        <div class="mark_div col-xs-12 col-sm-6 sol-md-3 col-lg-3 no-margin ">
            <div class="row">
            <div class="col-xs-12"> <p> <img class=" marketing-image" alt=""   src="shop/assets/images/banners/round4.png" /> </p></div>
