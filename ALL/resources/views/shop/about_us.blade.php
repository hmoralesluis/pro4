...
@section('main_content')
        ...
        <section id="s1" class="  who-content-light light-bg  inner-xs">
            <div class="container">
                <div class="row">

                    <h1 class="who-title-light" style="color: red"><i class="glyphicon glyphicon-star-empty"></i> {{trans('about_us.title.section1')}} </h1>

                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 section m-t-0">
                        <p>
        ...
        <section id="s2"class="  around-world who-content-bg inner-xs">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 section m-t-0">
                        <p>
        ...
        <section id="s3" class="    light-bg  who-content-light inner-xs">
            <div class="container">
                <div class="row">
        ...
        <section id="s3"class="  who-content-bg provedors inner-xs">
            <div class="container">
                <div class="row">
