...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'netviralpro', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_55aea65e6cbc3eba3648b968815bfbc5ee4a10c3c6637a7ff4a3a26566984d9e');
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/management/^');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/management/config/^');

        $j = new \Symfony\Component\Security\Http\AccessMap();
        $j->add($g, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $j->add($h, array(0 => 'ROLE_FREE', 1 => 'ROLE_PAYMENT', 2 => 'ROLE_ADMIN'), NULL);
        ...
        $m->setOptions(array('login_path' => '/', 'always_use_default_target_path' => true, 'default_target_path' => '/management', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $n->setOptions(array('login_path' => '/', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $a, $c), 2 => $l, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'secured_area', $m, $n, array('check_path' => '/check', 'username_parameter' => '_username', 'password_parameter' => '_password', 'use_forward' => false, 'require_previous_session' => true, 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57c367656a3de1.60453374', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $k, '/', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_PAYMENT' => array(0 => 'ROLE_FREE'), 'ROLE_ADMIN' => array(0 => 'ROLE_FREE', 1 => 'ROLE_PAYMENT', 2 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_FREE', 1 => 'ROLE_PAYMENT', 2 => 'ROLE_ADMIN', 3 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.java.bin' => 'C:\\Program Files\\Java\\jdk1.8.0_20\\bin\\java.EXE',
