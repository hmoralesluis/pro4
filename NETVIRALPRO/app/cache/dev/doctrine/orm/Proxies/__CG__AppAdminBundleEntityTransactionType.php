 ...
 */
class TransactionType extends \App\AdminBundle\Entity\TransactionType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\TransactionType' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\TransactionType' . "\0" . 'name', '' . "\0" . 'App\\AdminBundle\\Entity\\TransactionType' . "\0" . 'transactions');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransactionType $proxy) {
